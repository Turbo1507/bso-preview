...
(function () {
  var ru = {
    ...
    "unitgrp.frames": "Высокотехнологичное автоматизированное производство домовых конструкций",
    "unitgrp.furniture": "Производство корпусной и мягкой мебели, прочных дверей и панорамных окон для домов UNIT.",
    "unitgrp.space": "Все вопросы по сдаче в аренду и управлению недвижимостью закрываются под ключ, без участия инвестора",
    "unitgrp.note": "UNIT.BUILD ведёт стройку и разрешения, UNIT.FRAMES — производственные элементы, UNIT.FURNITURE — мебель и детали интерьера. Дальше подключается UNIT Space Management: эксплуатация, сервис и аренда организованы профессионально, без хаоса для владельца.",
  ...
  var en = {
    ...
    "unitgrp.frames": "High-tech automated production of house structural frames",
    "unitgrp.furniture": "Case and upholstered furniture, durable doors and panoramic windows for UNIT. homes",
    "unitgrp.space": "Rental and property management handled turnkey, with no involvement required from the investor",
    "unitgrp.note": "UNIT.BUILD runs construction and permits, UNIT.FRAMES supplies the structural elements, UNIT.FURNITURE makes the furniture and interior details. UNIT Space Management then takes over — operations, service and rental run professionally, without chaos for the owner.",
